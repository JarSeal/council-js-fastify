...
// null or undefined. Improves / optimizes performance.
...
export type TSettings = {
  ...
  sanitizeAll?: boolean;
  doCheckIsInDom?: boolean; // @TODO: remove (maybe not needed)
  replaceRootElem?: boolean;
};
...
export const globalSettings: TSettings = {
  sanitizer: null,
  sanitizeAll: false,
  doCheckIsInDom: false, // @TODO: remove (maybe not needed)
  replaceRootElem: true,
};

export const setSanitizer = (sanitizer: TSettings['sanitizer']) =>
  (globalSettings.sanitizer = sanitizer);
export const setSanitizeAll = (sanitizeAll: boolean) => (globalSettings.sanitizeAll = sanitizeAll);
...
export const CMP = (
  ...
  if (props?.attach) {
    ...
    if (props?.settings?.replaceRootElem !== undefined)
      globalSettings.replaceRootElem = props?.settings.replaceRootElem;
    if (globalSettings.replaceRootElem) {
